...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000ffb95d25cdaf73ffa8aef6f0c0f490de18fd46b0f5777802b2e3fa4d1fd"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1535592051, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // CarbonZero: 60 seconds
        nMaturity = 100;
         ...
         *
          CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1390095618, nBits=1e0ffff0, nNonce=28917698, vtx=1)
            ...
            vMerkleTree: e0028e
         */
        const char* pszTimestamp = "U.S. News & World Report Aug 29 2018 UBS to Sell Digital SmartWealth Platform to Fintech Startup";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1535592051;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1676812;
	...
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 29); // Public address WIF starts with "cz"
        ...
        strObfuscationPoolDummyAddress = "Cjx9dFr2gPynUxj2Yx6gZQQK38jpv57cDt";
        nStartMasternodePayments = 1536408000; // Sept 8, 2018 12:00:00 AM GMT
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51216;
        assert(hashGenesisBlock == uint256("0x7b168018bf43e026e862ed58f72c2c43760148849ca38f5cf166db85d9919744"));
